    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.searchRow}>
        <Pressable onPress={useMyLocation} disabled={locating} accessibilityRole="button" style={[styles.locBtn, coords && styles.locBtnOn]}>
          {locating ? <ActivityIndicator color={colors.white} /> : <Text style={[styles.locText, coords && { color: colors.brand700 }]}>{coords ? "Using your location" : "Use my location"}</Text>}
        </Pressable>
        <TextInput
          style={styles.city}
          value={city}
...
const styles = StyleSheet.create({
  ...
  locText: { color: colors.white, fontWeight: "700", fontSize: 14 },
